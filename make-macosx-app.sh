...
RENDERER_METAL_NAME="${RENDERER_METAL}.dylib"
...
for ARCH in $SEARCH_ARCHS; do
	...
	IOQ3_RENDERER_METAL="${RENDERER_METAL}_${CURRENT_ARCH}.dylib"
	...
	if [ -e ${BUILT_PRODUCTS_DIR}/${IOQ3_RENDERER_METAL} ]; then
		IOQ3_RENDERER_METAL_ARCHS="${BUILT_PRODUCTS_DIR}/${IOQ3_RENDERER_METAL} ${IOQ3_RENDERER_METAL_ARCHS}"
	fi
...
action "${BUNDLEBINDIR}/${RENDERER_METAL_NAME}"			"${IOQ3_RENDERER_METAL_ARCHS}"
...
symlinkArch "${RENDERER_METAL}" "${RENDERER_METAL}" "_" "${BUNDLEBINDIR}"
